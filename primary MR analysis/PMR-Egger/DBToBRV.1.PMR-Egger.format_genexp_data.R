...
for (exposure in exposure_all){
  file = fread(paste('/public/home/yanganyi/Desktop/genexpMR/data/gwas_summary/mr_format/PMR-Egger/brain_disorder/', exposure, '.format.txt', sep=''), data.table = F)
  file$gene = exposure
  ...
  outname = paste('/public/home/yanganyi/Desktop/genexpMR/data/gwas_summary/mr_format/PMR-Egger/brain_disorder/',exposure, '.EUR.signif_pairs_5e-8.txt',sep='')
  write.table(file, outname, sep=' ', row.names=F,quote=F)
  
  selected_snp = unique(file$SNP)
  outname = paste('/public/home/yanganyi/Desktop/genexpMR/data/gwas_summary/mr_format/PMR-Egger/brain_disorder/allele/', exposure,'.EUR.signif_pairs_5e-8.allele',sep='')
