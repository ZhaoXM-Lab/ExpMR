...
for (outcome in outcome_all){
  ...
  for (tissue in tissue_all){
    ...
    filename = paste('data/gene_expression/Malhotra_lab/mr_format/TwoSampleMR/SNP_in_outcome_clumped_txt/',tissue,'.clumped.txt',sep='')
    ...
    outfilename = paste('results/TwoSampleMR/CellToIDP/CellToVolume/', outcome, '.', tissue,'.TwoSampleMR.txt',sep='')
