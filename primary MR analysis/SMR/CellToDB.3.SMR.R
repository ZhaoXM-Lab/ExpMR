...
indiv = function(j){
  ...
  command = paste('/public/home/yanganyi/Desktop/Software/smr-1.3.1-linux-x86_64/smr-1.3.1', 
                  ...
                  ' --gwas-summary /public/home/yanganyi/Desktop/genexpMR/data/gwas_summary/mr_format/SMR/brain_disorder/',pheno,'.format.txt',
                  ' --beqtl-summary /public/home/yanganyi/Desktop/genexpMR/data/gene_expression/Malhotra_lab/mr_format/SMR/',tissue,
                  ' --out /public/home/yanganyi/Desktop/genexpMR/results/SMR/CellToDisorder/', pheno,'.',tissue, 
                  ' --thread-num 20', sep = '')
