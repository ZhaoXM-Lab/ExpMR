...
#TWAS--
file1 = fread('results/TWAS/TWAS.14BrainTissuesToDisorder.all.txt', data.table = F)
file1 = file1[,c('pheno','tissue','gene','effect_size','pvalue')]
names(file1) = c('pheno','tissue','gene','b.twas','p.twas')
file1 = file1[,-which(names(file1) == 'tissue')]
#PMR-Egger--
file2 = fread('results/PMR-Egger/PMR-Egger.CellToDisorder.all.txt', data.table = F)
...
#SMR--
file3 = fread('results/SMR/SMR.CellToDisorder.all.txt', data.table = F)
...
#TwoSampleMR--
file4 = fread('results/TwoSampleMR/TwoSampleMR.CellToDisorder.all.txt', data.table = F)
...
#GSMR--
file5 = fread('results/GSMR/GSMR.CellToDisorder.all.txt', data.table = F)
...
write.table(signif_gene, paste('results/','signif_genes.CellToDisorder.fdr.txt',sep=''), sep="\t", row.names=F, col.names=T, quote=F)
